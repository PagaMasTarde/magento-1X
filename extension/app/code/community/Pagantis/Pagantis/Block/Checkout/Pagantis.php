    ...
    protected function _construct()
    {
        ...
        if (in_array(strtolower($locale), $allowedCountries)) {
            ...
            $template->assign(array(
                ...
                'pagantisCSSSelector'        => $extraConfig['PAGANTIS_SIMULATOR_CSS_POSITION_SELECTOR_CHECKOUT'],
                'pagantisPriceSelector'      => $extraConfig['PAGANTIS_SIMULATOR_CSS_PRICE_SELECTOR_CHECKOUT'],
                'pagantisQuotesStart'        => $extraConfig['PAGANTIS_SIMULATOR_START_INSTALLMENTS'],
                'pagantisSimulatorType'      => $extraConfig['PAGANTIS_SIMULATOR_DISPLAY_TYPE_CHECKOUT'],
