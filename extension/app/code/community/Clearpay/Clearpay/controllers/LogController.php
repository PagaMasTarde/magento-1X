...
/**
 * Class Clearpay_Clearpay_LogController
 */
class Clearpay_Clearpay_LogController extends AbstractController
{
    /**
     * @var bool $error
     */
    ...
    public function downloadAction()
    {
        ...
        $tableName = Mage::getSingleton('core/resource')->getTableName("clearpay_log");
    ...
    public function authorize()
    {
        ...
        $privateKey = $moduleConfig['clearpay_secret_key'];
